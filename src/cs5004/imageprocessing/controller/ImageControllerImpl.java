                    ...
                    try {
                      switch (filterSelection) {
                        case 1 -> {
                          ...
                          view.displayMessage("Blur filter applied. Would you like to apply another filter?");
                        }
                        case 2 -> {
                          this.model.applyFilter("sharpen");
                          view.displayMessage("Sharpen filter applied. Would you like to apply another filter?");
                        }
                        case 3 -> {
                          ...
                          view.displayMessage("Would you like to perform more operations another image?");
                  ...
                  try {
                    switch (transformationSelection) {
                      case 1:
                        ...
                        view.displayMessage("Greyscale transformation applied and image saved as " + imageName + "-greyscale.png");
                        break;
                      case 2:
                        this.model.applyTransformation("sepia");
                        this.saveImage(imageName + "-sepia.png");
                        view.displayMessage("Sepia transformation applied and image saved as " + imageName + "-sepia.png");
                        break;
                      default:
